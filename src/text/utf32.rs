pub fn utf8_to_utf32(utf8: &[u8], result: &mut Vec<char>) {
    let mut i = 0;
    ...
    while i < utf8.len() {
        ...
        if first_byte < 0x80 {
            unsafe {
                result.push(char::from_u32_unchecked(first_byte));
            }
            ...
            unsafe {
                result.push(char::from_u32_unchecked(value));
            }
...
pub fn utf32_to_utf8(utf32: &[char], result: &mut Vec<u8>) {
